...
export default function Header() {
  ...
  // Close the mobile navigation when the window size changes
  React.useEffect(() => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <Navbar className={`sticky top-0 z-10 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4 ${openNav ? "hidden" : ""}`}>
      ...
      {/* {openNav && (
        <div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600 z-10">
      ...
      {/* Button to toggle bottom navbar on mobile */}
      <div id="bottom_navbar" className="lg:hidden fixed bottom-0 left-0 right-0 p-4 z-10">
