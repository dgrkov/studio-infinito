  ...
  return (
    <div className="p-5 flex justify-center flex-col items-center dark:bg-dark-primary">
      {serviceTypes.map((serviceType) => (
        <Card className="mb-5 w-full md:w-[40%] border bg-white dark:bg-dark-secondary dark:border-dark-border">
          ...
          <CardFooter className="pt-0">
            <Button
              ripple={false}
              fullWidth={true}
              className="bg-blue-gray-900/10 text-gray-900 hover:bg-blue-gray-900/20 
                dark:bg-dark-button-primary dark:text-dark-text-primary dark:hover:bg-dark-button-hover"
